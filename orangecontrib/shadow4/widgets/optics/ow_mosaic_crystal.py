...
class _OWMosaicCrystal(OWOpticalElementWithSurfaceShape):
    class Inputs:
    ...
    def __init__(self):
        super(_OWMosaicCrystal, self).__init__()
    ...
    def populate_tab_crystal_geometry(self, subtab_crystal_geometry):
        ...
        oasysgui.lineEdit(subtab_crystal_geometry, self,
                                                "mosaicity_fwhm_deg", "Mosaicity FWHM [deg]", tooltip="mosaicity_fwhm_deg",
                                                valueType=float, labelWidth=260, orientation="horizontal")
    ...
    @Inputs.bragg_preprocessor_data
    ...
    def get_beamline_element_instance(self):
        ...
        if self.modified_surface:
            ...
            elif self.surface_shape_type == 2: return   S4EllipsoidMosaicCrystalElement()
            elif self.surface_shape_type == 3: return S4HyperboloidMosaicCrystalElement()
            elif self.surface_shape_type == 4: return  S4ParaboloidMosaicCrystalElement()
            elif self.surface_shape_type == 5: return      S4ToroidMosaicCrystalElement()
            elif self.surface_shape_type == 6: return       S4ConicMosaicCrystalElement()
