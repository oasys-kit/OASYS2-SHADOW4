...
from oasys2.widget.gui import MessageDialog
...
class PlotScatter(AutomaticElement):
    ...
    class Inputs:
        ...
        shadow_data_color = Input("Shadow Data (color)", ShadowData, default=True, auto_summary=False)
